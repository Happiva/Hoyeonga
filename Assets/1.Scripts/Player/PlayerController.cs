...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //점프        
        if (Input.GetButtonDown("Jump") && IsGrounded() && GameManager.instance.canAction)
        {
        ...
        //앉기
        if (Input.GetButton("Sit") && IsGrounded() && GameManager.instance.canAction)
        {            
            sitDown = true;
        }
    ...
    {
        GameManager.instance.canAction = flag;
    }
